...
export default function XemLich() {
  ...
  return (
    ...
    >
      ...
      {/* 1. THANH LỊCH NGANG */}
      <motion.div variants={itemVariants} className="mx-[-17] mt-4 bg-gray-50 rounded-[20px] p-1.5 flex items-center justify-between border border-gray-100 shadow-sm relative z-20">
      ...
      <motion.div variants={itemVariants} className="mx-[-17] h-[420px] overflow-y-auto bg-gray-50/50 rounded-[26px] shadow-inner border border-gray-100 no-scrollbar relative mb-2">
        {loading ? (
